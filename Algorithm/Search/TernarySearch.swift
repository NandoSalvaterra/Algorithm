...
class TernarySearch {
     ...
     */
    func ternarySearch(array: [Int], searchableValue: Int) -> Int? {
        var min = 0
        ...
        while (min < max) {
            ...
            else if (array[firstPivot] > searchableValue) { max = firstPivot - 1 }
            else if (array[secondPivot] == searchableValue) { return secondPivot }
            else if (array[secondPivot] > searchableValue) { min = firstPivot + 1 ; max = secondPivot - 1 }
            else { min = secondPivot + 1 }
        }
        return nil
    }
     ...
     */
    func optimizedTernarySearch(array: [Int], searchableValue: Int) -> Int? {
        var min = 0
        var max = (array.count - 1)
        var firstPivot = 0
        var secondPivot = 0
     ...
     */
    func recursiveTernarySearch(array: [Int], start: Int, end: Int, searchableValue: Int) -> Int? {
        var start = start
        var end = end
        var firstPivot = 0
        var secondPivot = 0
