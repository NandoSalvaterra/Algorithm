...
class SequencialSearch {
    ...
    //Sequencial Search Algorithm O(N)
     ...
     */
    static func disorderedSequencialSearch(array: [Int], searchableValue: Int) -> Int? {
     ...
     */
    static func orderedSequencialSearch(array: [Int], searchableValue: Int) -> Int? {
        for index in 0..<array.count {
