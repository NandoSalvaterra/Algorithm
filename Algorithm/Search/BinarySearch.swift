...
class BinarySearch {
     ...
     */
    func repetitiveBinarySearch(array: [Int], searchableValue: Int) -> Int? {
        var min = 0
     ...
     */
    func optimizedRepetitiveBinarySearch(array: [Int], searchableValue: Int) -> Int? {
        var min = 0
        var max = (array.count - 1)
     ...
     */
    func bestOptimizedRepetitivedBinarySearch(array: [Int], searchableValue: Int) -> Int? {
        var min = 0
        var max = (array.count - 1)
     ...
     */
    func recursiveBinarySearch(array: [Int], start: Int, end: Int, searchableValue: Int) -> Int? {
